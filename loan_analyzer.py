...
# YOUR CODE HERE!
average_loans = sum(loan_costs) / len(loan_costs)
print (average_loans)
...
remainingMonth = loan.get("remaining_months")
print(f"The remaining months : {remainingMonth} months.")
...
# YOUR CODE HERE!
present_value = calc_present_value(future_value, remaining_months, 0.2)
...
for current_loan in loans:
    if current_loan.get("loan_price") < 500:
